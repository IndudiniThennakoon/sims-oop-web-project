				...
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							...
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="students.html">Students</a>
								</li>
							</ul>
						</div>
					</div>
										...
										<div class="col-12 col-sm-6">
											<div class="form-group">
												<label>First Name</label> <input type="text"
													class="form-control" value="Nathan Humphries" />
											</div>
										</div>
										<div class="col-12 col-sm-6">
											<div class="form-group">
										...
										<div class="col-12 col-sm-6">
											<div class="form-group">
												<label>Student Id</label> <input type="text"
													class="form-control" value="PRE1234" />
											</div>
										</div>
										<div class="col-12 col-sm-6">
											<div class="form-group">
...
86 Lamphey Road, Thelnetham</textarea>
											</div>
										</div>
										<div class="col-12 col-sm-6">
											<div class="form-group">
